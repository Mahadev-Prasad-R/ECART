  ...
  return (
    <section className='w-full min-h-screen flex items-center justify-center bg-amber-50 '>
      ...
      <div className='space-y-4 tracking-wider flex flex-col items-center mt-[-150px]' >
        ...
        <div className='w-[380px] h-[300px] bg-gray-600 p-8 rounded-xl '>
          <form onSubmit={handleSubmit}>
            ...
            <div className='flex justify-center'>
              <button type="submit" value='Login' className='w-24 bg-purple-500 py-2 text-white rounded-md tracking-wide transition hover:bg-purple-600'>Login</button>
            </div>
